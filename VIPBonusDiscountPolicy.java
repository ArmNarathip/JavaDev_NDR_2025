 ...
 * This class applies a base percentage and an
 * 
 */
...
public class VIPBonusDiscountPolicy implements DiscountPolicy {
    ...
    private int bonusPercent; // ส่วนลดพิเศษที่จะได้รับเพิ่มจาก base percent
    ...
    public double applyDiscount(double amount) {
        ...
        // Cap the total discount at 100% tot prevent negative prices
        if (totalPercent > 100) {
            totalPercent = 100;
        }
